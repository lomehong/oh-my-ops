...
| S3 | `/ops-audit` | ✅ 主人确认：被拒条目回看成功（`ops_service blocked … ERR_PERMISSION`），头部含可读范围声明 |
| S4 | `/ops-audit 1` | ✅ 主人确认：仅显示 S3 的自审计条目 `ops-audit read/ok`——**先读后写闭环** |
| S5/S6 | `/ops-audit abc` | ✅ 主人确认：参数防御生效 |
